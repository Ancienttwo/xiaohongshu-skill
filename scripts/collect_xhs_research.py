...
from research_report import account_key, build_accounts, build_markdown
from title_heuristics import infer_hook_angle
from workspace_parsing import extract_bullets, extract_keyword_map, extract_section, parse_metadata, read_text
from workspace_paths import slugify as slugify_base
from xhs_cli_utils import DEFAULT_XHS_BINARY, XhsCliError, run_xhs_command, write_json


def slugify(value: str) -> str:
    return slugify_base(value, keep_cjk=True, fallback="xhs")
